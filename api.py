...
@app.route('/api/v1/blake-blake/resources/spring/all', methods=['GET'])
@cross_origin()
def api_all():
    return jsonify(classes_db)

@app.route('/api/v1/blake-blake/resources/spring/professor', methods=['GET'])
@cross_origin()
def prof_call():
...
@app.route('/api/v1/blake-blake/resources/spring/credit', methods=['GET'])
@cross_origin()
def cred_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
...
@app.route('/api/v1/blake-blake/resources/spring/days', methods=['GET'])
@cross_origin()
def days_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
...
@app.route('/api/v1/blake-blake/resources/spring/room', methods=['GET'])
@cross_origin()
def room_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
...
@app.route('/api/v1/blake-blake/resources/spring/time', methods=['GET'])
@cross_origin()
def time_call():
    # Check if an ID was provided as part of the URL.
    # If ID is provided, assign it to a variable.
